...
public class TestDataProvider {
    ...
    public static Book getExistingBook() {
        var author = new Author("1", AUTHOR_NAME);
        var genre = new Genre("1", GENRE_NAME);
        return new Book("1", "TEST BOOK", author, genre, new ArrayList<>());
    }
    ...
    public static Book getExistingBookWithComment() {
        ...
        var book = new Book("1", BOOK_NAME, author, genre, List.of(comment));
        comment.setBook(book);
        return book;
    }

    public static BookDto getExistingBookDto() {
        return new BookDto("1", BOOK_NAME, AUTHOR_NAME, GENRE_NAME);
    }

    public static BookWithCommentDto getExistingBookWithCommentDto() {
        var comment = new CommentDto(null, COMMENT_TEXT);
        return new BookWithCommentDto("1", BOOK_NAME, AUTHOR_NAME, GENRE_NAME, List.of(comment));
    }

    public static AuthorDto getExistingAuthorDto() {
        return new AuthorDto("1", AUTHOR_NAME);
    }

    public static GenreDto getExistingGenrerDto() {
        return new GenreDto("1", GENRE_NAME);
    }
