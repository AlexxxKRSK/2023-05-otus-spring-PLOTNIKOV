...
public class BookController {
    ...
    public boolean deleteBookById(@ShellOption String id) {
    ...
    public String addCommentToBook(@ShellOption @NonNull String bookId,
    ...
    public boolean deleteCommentById(@ShellOption @NonNull String commentId) {
